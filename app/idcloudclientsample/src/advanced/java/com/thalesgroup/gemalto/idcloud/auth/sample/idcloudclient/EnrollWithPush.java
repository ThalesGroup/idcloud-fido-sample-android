...
public class EnrollWithPush {

    private FragmentActivity activity;
    private String code;
    private IdCloudClient idCloudClient;

    public EnrollWithPush(FragmentActivity activity, String code, String url) {
            ...
            public void run() {
                FirebaseMessaging.getInstance().getToken().addOnCompleteListener(new OnCompleteListener<String>() {
                    ...
                    public void onComplete(@NonNull Task<String> task) {
                        ...
                        boolean enablePushNoti = sharedPref.getBoolean(activity.getString(R.string.enable_push_noti_key), false);
                        if (task.isSuccessful() && enablePushNoti) {
